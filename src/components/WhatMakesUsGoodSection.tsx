  ...
  return (
    <div className="h-100% py-[10rem] px-[7.5%] bg-gradient-to-r from-fuchsia-600 to-pink-600 relative mt-4">
      ...
      <div className="flex flex-wrap justify-between gap-5">
        <div className="w-[48%]">
          <h3 className="text-3xl font-semibold mb-2">Bespoke</h3>
          <p>
        ...
        <div className="w-[48%]">
          <h3 className="text-3xl font-semibold mb-2">Thoughtful</h3>
          <p>
        ...
        <div className="w-[48%]">
          <h3 className="text-3xl font-semibold mb-2">Seamless</h3>
          <p>
        ...
        <div className="w-[48%]">
          <h3 className="text-3xl font-semibold mb-2">Impactful</h3>
          <p>
